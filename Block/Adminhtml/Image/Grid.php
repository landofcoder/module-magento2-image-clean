...
namespace Lof\ImageClean\Block\Adminhtml\Image;
...
class Grid extends \Magento\Backend\Block\Widget\Grid\Extended
{
    ...
    /**
     * @var \Lof\ImageClean\Model\imageFactory
     */
     ...
     * @param \Lof\ImageClean\Model\imageFactory       $imageFactory
    ...
    public function __construct(
        ...
        \Lof\ImageClean\Model\ImageFactory $ImageFactory,
    ...
    protected function _prepareColumns()
    {
        ...
        $this->addColumn(
            ...
            array(
                'header' => __('Image'),
                'index' => 'value',
                'renderer' => '\Lof\ImageClean\Block\Adminhtml\Image\Grid\Renderer\Image',
            )
        );
        ...
        $this->addColumn('action', array(
            ...
            'renderer' => 'Lof\ImageClean\Block\Adminhtml\Image\Grid\Renderer\Action',
            'index' => 'value_id',
        ));
    ...
    /**
     * @param \Lof\ImageClean\Model\image|\Magento\Framework\Object $row
     *
     * @return string
     */
